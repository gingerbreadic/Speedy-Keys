...
public class registerActivity extends AppCompatActivity {
    ...
    private TextView usernameEditText, registration_passEditText, registration_confirmpassEditText, registration_emailEditText, registrationText;
        ...
        verify_email_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!username.isEmpty() && !password.isEmpty() && !confirm_password.isEmpty() && !email.isEmpty()) {
                    ...
                    buttonSendEmail(v, email); // Call the new method to send the email
    ...
    public void buttonSendEmail(final View view, final String email) {
            ...
            protected Void doInBackground(Void... voids) {
                {
                    ...
                    try {
                        ...
                        message.setContent("Code for registration in Typing Challenge \n <h2>" + verification_code + "<h2/>", "text/html");
